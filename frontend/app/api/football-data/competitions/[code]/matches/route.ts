/**
 * GET /api/football-data/competitions/[code]/matches
 *
 * Fetches matches for a specific competition from football-data.org API
...
export async function GET(
  ...
  try {
    ...
    let url = `${FOOTBALL_DATA_API_BASE_URL}/competitions/${code}/matches`;
